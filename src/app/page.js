        ...
        <div className="tw-flex tw-flex-col tw-gap-2 tw-mt-3">
          ...
          <div className="tw-rounded-[10px] tw-shadow tw-flex tw-text-[14px] tw-min-h-[80px]">
            <Button
              ...
              color="inherit"
              onClick={() => todosStatus.toggleTodoCompleted(todo.id)}
            >
              <FaCheck
                className={classNames(
                  'tw-text-3xl',
                  todo.completed
                    ? 'tw-text-[--mui-color-primary-main]'
                    : 'tw-text-[#dcdcdc]'
                )}
              />
            </Button>
            ...
            <div className={classNames(
              'tw-bg-blue-300 tw-flex tw-items-center tw-p-3 tw-flex-grow hover:tw-text-[--mui-color-primary-main] tw-whitespace-pre-wrap tw-leading-relaxed tw-break-words',
              { 'tw-line-through': todo.completed } // 완료된 경우 텍스트에 줄 긋기
            )}>
              할 일 : {todo.content}
            </div>
            <Button
